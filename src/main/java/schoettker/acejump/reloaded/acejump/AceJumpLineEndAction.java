...
import schoettker.acejump.reloaded.acejump.offsets.LineEndsOffsetFinder;

public class AceJumpLineEndAction extends AnAction {

    @Override
    public void actionPerformed(@NotNull AnActionEvent e) {
        AceJumpAction.getInstance().switchEditorIfNeed(e);
        AceJumpAction.getInstance().setOffsetsFinder(new LineEndsOffsetFinder());
